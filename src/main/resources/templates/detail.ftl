            ...
            <#if comments??>
                <#list comments as comment>
                    <div tabindex="-1" class="zm-item-answer  zm-item-expanded" itemprop="topAnswer" itemscope=""
                        ...
                        <div class="zm-item-vote-info" data-votecount="${comment.likeCount!}" data-za-module="VoteInfo">
                        ...
                        <div class="zm-item-meta answer-actions clearfix js-contentActions">
                            <div class="zm-meta-panel">
                                <#if comment.comment.createdDate??>
                                    <a itemprop="url" class="answer-date-link meta-item" target="_blank" href="">发布于
                                    <#--$date.format('yyyy-MM-dd HH:mm:ss', $comment.comment.createdDate)-->
